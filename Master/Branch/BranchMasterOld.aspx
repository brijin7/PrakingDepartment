<%@ Page Title="Branch Master" Language="C#" MasterPageFile="~/PreParking.master" AutoEventWireup="true"
    CodeFile="BranchMasterOld.aspx.cs" Inherits="Master_BranchMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterPage" runat="Server">
    ...
    <div class="container-fluid containerBg">
        <div class="row PageRoutePos">
            ...
            <div>
                <asp:Label ID="lblNavSecond" runat="server" CssClass="pageRoutecol" Text="Branch Master"></asp:Label>
            </div>
        ...
        <div id="divForm" runat="server" visible="false">
            ...
            <div class="tab">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                        <div id="chkcheckout" style="margin-left: 14px">
                ...
                <div class="ddwnoverflow">
                    <div class="table-responsive section">
                        <asp:GridView
                            ...
                            BorderStyle="None"
                            PageSize="100" OnRowDataBound="gvBranchmaster_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="advanceBookingHourOrDayType" Visible="false" HeaderStyle-CssClass="gvHeader">
                                    <ItemTemplate>
                                        <asp:Label
                                            ID="lbladvanceBookingHourOrDayType"
                                            runat="server"
                                            Text='<%#Bind("advanceBookingHourOrDayType") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="advanceBookingHourOrDay" Visible="false" HeaderStyle-CssClass="gvHeader">
                                    <ItemTemplate>
                                        <asp:Label
                                ...
                                <asp:TemplateField HeaderText="advanceBookingCharges" Visible="false" HeaderStyle-CssClass="gvHeader">
                                    <ItemTemplate>
                                        <asp:Label
                                ...
                                <asp:TemplateField HeaderText="minHour" Visible="false" HeaderStyle-CssClass="gvHeader">
                                    <ItemTemplate>
                                        <asp:Label
                                            ID="lblminHour"
                                            runat="server"
                                ...
                                <asp:TemplateField HeaderText="maxHour" Visible="false" HeaderStyle-CssClass="gvHeader">
                                    <ItemTemplate>
                                        <asp:Label
                                            ID="lblmaxHour"
                                            runat="server"
                                ...
                                <asp:TemplateField HeaderText="minDay" Visible="false" HeaderStyle-CssClass="gvHeader">
                                    <ItemTemplate>
                                        <asp:Label
                                            ID="lblminDay"
                                            runat="server"
                                ...
                                <asp:TemplateField HeaderText="maxDay" Visible="false" HeaderStyle-CssClass="gvHeader">
                                    <ItemTemplate>
                                        <asp:Label
                                            ID="lblmaxDay"
                                            runat="server"
    ...
    <script>
        ...
        function showTab(n) {           
            ...
            if (n == 0) {
                ...
                //alert("2")
                if (n == 1) {
                    var MBchecked = document.getElementById('<%=chkMultiBook.ClientID %>').checked;
                    var OBchecked = document.getElementById('<%=chkOnlineB.ClientID %>').checked;

                    if (MBchecked == false) {
                        document.getElementById('<%=dvMultiDays.ClientID %>').style.display = "none";
                    }
                    else {
                        document.getElementById('<%=dvMultiDays.ClientID %>').style.display = "block";
                    }
                    if (OBchecked == false) {
                        document.getElementById('<%=dvOnlineBooking.ClientID %>').style.display = "none";
                    }
                    else {
                        document.getElementById('<%=dvOnlineBooking.ClientID %>').style.display = "block";
                    }
