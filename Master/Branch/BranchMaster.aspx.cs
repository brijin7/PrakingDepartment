...
public partial class Master_BranchMaster : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                gvBranchmaster.Columns[24].Visible = false;//VIEW
                gvBranchmaster.Columns[23].Visible = true;//Approval
                gvBranchmaster.Columns[22].Visible = true;//Delete
                gvBranchmaster.Columns[21].Visible = true;//Edit              
                gvBranchmaster.Columns[20].Visible = false;//phoneNumber
            } //else if (Session["UserRole"].ToString().Trim() == "A")
            else
            {
                gvBranchmaster.Columns[24].Visible = true;//VIEW
                gvBranchmaster.Columns[23].Visible = false;
                gvBranchmaster.Columns[22].Visible = false;
                gvBranchmaster.Columns[21].Visible = false;
                gvBranchmaster.Columns[20].Visible = true;
            }
            BindOwner();
            BindBranchMaster();
        }
    ...
    public void InsertBranch()
    {
        try
        {
            ...
            string PayAtCheckOut = string.Empty;
            string PayAtCheckIn = string.Empty;
            ...
            //    PayAtCheckOut = "N";
            //}
            if (rbtnPayType.SelectedValue== "PCO")
            {
                PayAtCheckOut = "Y";
                PayAtCheckIn = "N";
            }
            ...
            using (var client = new HttpClient())
            {
                ...
                var Insert = new BranchMasterClass()
                {
                    ...
                    isPayAtCheckoutAvailable = PayAtCheckOut,
                    isPayAtCheckInAvailable = PayAtCheckIn,
                    activeStatus = "A",
    ...
    public void UpdateBranchMaster()
    {
        try
        {
            ...
            if (hfImageUrl.Value == "../../images/EmptyImageNew.png")
            {
                hfImageUrl.Value = "";
            }
            ChkBoxSelect();
    ...
    protected void LnkEdit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Label lblisPayAtCheckOut = (Label)gvrow.FindControl("lblisPayAtCheckoutAvailable");
            Label lblisPayAtCheckIn = (Label)gvrow.FindControl("lblisPayAtCheckInAvailable");
            ...
            txtGSTNumber.Text = lblGvGSTNumber.Text;
            ...
            //}
            if (lblisPayAtCheckOut.Text == "Y" && lblisPayAtCheckIn.Text == "N")
            {
                rbtnPayType.SelectedValue = "PCO";
            }
            else
            {
                rbtnPayType.SelectedValue = "PCI";
            }
    ...
    protected void lnkView_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            txtAlterPhoneNo.Enabled = false;
            txtEmailId.Enabled = false;
            chkMultiBook.Enabled = false;
            chkOnlineB.Enabled = false;
            chkPayB.Enabled = false;
            chkPaylater.Enabled = false;
            chkChechIn.Enabled = false;
            rbtnPayType.Enabled = false;
            txtGSTNumber.Enabled = false;
            txtLicenseNo.Enabled = false;
            txtLicensePeriodFrom.Enabled = false;
            txtLicensePeriodTo.Enabled = false;
            chkWorkingDays.Enabled = false;
    ...
    public class BranchMasterClass
    {
        ...
        public String isPayAtCheckInAvailable { get; set; }
