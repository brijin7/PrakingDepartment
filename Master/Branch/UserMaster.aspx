<%@ Page Title="User Master" Language="C#" MasterPageFile="~/PreParking.master" AutoEventWireup="true" CodeFile="UserMaster.aspx.cs"
...
<asp:Content ID="FrmEmployeeMaster" ContentPlaceHolderID="MasterPage" runat="Server">
    ...
    <div class="container-fluid containerBg">
        ...
        <div class="row PageRoutePos">
            ...
            <div>
                <asp:Label ID="lblNavSecond" runat="server" CssClass="pageRoutecol" Text="User Master"></asp:Label>
            </div>
        ...
        <div id="divForm" runat="server" visible="false">
            ...
            <div class="divTitle row pt-4 pl-4 justify-content-between">
                <div>
                    <h4 class="card-title"><span id="spAddorEdit" runat="server"></span>User <span class="Card-title-second">Master </span></h4>
                </div>
            </div>
                ...
                <div class="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-8 ">
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <asp:TextBox ID="txtEmployeename" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="50" 
                                TabIndex="1"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="EmployeeMaster1"
                                ControlToValidate="txtEmployeename" CssClass="rfvClr" ErrorMessage=" Enter User Name"> </asp:RequiredFieldValidator>
                        </div>
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <div class="input-group-append">
                                <asp:TextBox ID="txtPassword" runat="server" MaxLength="50" AutoComplete="off"
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <asp:TextBox ID="txtPincode" runat="server" CssClass="form-control" MaxLength="6" onkeypress="return isNumber(event);"
                                onchange="myFunction()" AutoComplete="off" TabIndex="3"></asp:TextBox>
                    ...
                    <div class="row mt-1">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" TextMode="MultiLine"
                                AutoComplete="off" TabIndex="4"></asp:TextBox>
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" MaxLength="50"
                                TabIndex="5" CssClass="form-control" AutoComplete="off">  </asp:TextBox>
                    ...
                    <div class="row mt-2">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <asp:TextBox ID="txtPhoneNo" runat="server" CssClass="form-control " AutoComplete="off"
                                TabIndex="6" onkeypress="return isNumber(event);" MaxLength="10" MinLength="10"></asp:TextBox>
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <asp:TextBox ID="txtAlterPhoneNo" runat="server" CssClass="form-control " AutoComplete="off"
                                TabIndex="7" onkeypress="return isNumber(event);" MaxLength="10"></asp:TextBox>
            ...
            <div class="row p-4 justify-content-end">
                <asp:Button runat="server" CssClass="pure-material-button-contained nextBtn mr-2" ValidationGroup="EmployeeMaster1"
                    Text="Submit" ID="btnSubmit" TabIndex="16" OnClick="btnSubmit_Click" />
                <asp:Button ID="btnReset" CssClass="pure-material-button-contained btnBgColorCancel" Text="Cancel"
                    TabIndex="17" CausesValidation="false" runat="server" Style="width: 108px;" OnClick="btnReset_Click" />
            </div>
        </div>
        ...
        <div id="divGv" runat="server">
            <div class="divTitle row pt-4 pl-4 justify-content-between">
                <div>
                    <h4 class="card-title">User <span class="Card-title-second">Master </span></h4>
                </div>
                <div>
                    <asp:LinkButton ID="btnAdd" runat="server" OnClick="btnAdd_Click" OnClientClick="Capture();"
                    ...
                    <div class="table-responsive section">
                        <asp:GridView ID="gvEmpmaster" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Address & Location" HeaderStyle-CssClass="gvHeader" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblgvaddresss" runat="server" Text='<%#Eval("address").ToString() +  "," + Eval("city") +  "," +  Eval("district") +  "," + Eval("state") %> '>
                                        </asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Role" HeaderStyle-CssClass="gvHeader">
                                    <ItemTemplate>
                                        <asp:Label
                                            ID="lblgvemuserRole"
                                            runat="server"
                                            Text='<%#Eval("userRole").ToString() == "E"?"Employee" :Eval("userRole").ToString()%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
