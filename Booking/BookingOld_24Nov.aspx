<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookingOld_24Nov.aspx.cs" Inherits="Booking_Booking" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<!DOCTYPE html>

<html style="overflow-x: hidden; overflow-y: auto;" class="section">
<head runat="server">
    <meta charset="utf-8" />
                ...
                <fieldset>
                    <div style="display: flex; margin-bottom: 0.75rem;">
                        ...
                        <div id="divCount" runat="server" visible="false"
                            class="divcountbg row col-9 col-sm-9 col-md-9 col-lg-9 col-xl-9 justify-content-center">

                            <fieldset class="legBorder">
                                ...
                                <div>
                                    ...
                                    <span class="DotText">Normal (<asp:Label
                                        ...
                                        Style="font-size: 16px; font-weight: bold; display: inline;"></asp:Label>)
                                    </span>&nbsp;&nbsp;|&nbsp;&nbsp;
...
Style="font-size: 16px; font-weight: bold; display: inline;"></asp:Label>)
                            ...
                            <fieldset class="legBorder" style="margin-left: 7rem !important;">
                ...
                <i class="fa-solid fa-xmark"></i></asp:LinkButton>
                    ...
                    <div id="Formbackground" runat="server" class="Formbackground">
                        ...
                        <div class="slot__container divslotbg" style="margin-top: 1px;">
                            <div class="row">
                                <div id="Divslotrow" runat="server"
                                                ...
                                                <div class="Date__Container" style="margin-bottom: 0rem">
                                                    ...
                                                    <div class="Date From__Date" id="divMobileNo" runat="server">
                                                        ...
                                                        <asp:TextBox
                                                            ...
                                                            runat="server"
                                                            TabIndex="8"
                                                            CssClass="txtSummary txtDate txtFromDate form-control" OnTextChanged="txtmobileNo_TextChanged" AutoPostBack="true">
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator
                                                            ID="RfvMobNo"
                                                            ValidationGroup="BookingSlot"
                                                    ...
                                                    <div class="Date To__Date" id="divVehicleNo" runat="server">
                                                        <asp:Image ID="ImgSummary" runat="server" Visible="false" Style="height: 3.5rem; margin-top: -14px;" />
                                                        <asp:Label
                                                            ID="lblVehicleNo"
                                                            runat="server"
                                                            CssClass="lblSummary"
                                                        ...
                                                        <asp:TextBox
                                                            ...
                                                            TabIndex="9" MaxLength="10" Style="text-transform: uppercase;"
        ...
        <div id="div1" runat="server" visible="true" style="position: absolute; top: 40%; left: 0;">
            <div class="row">
