...
public partial class Booking_BookingWithOutSlot : System.Web.UI.Page
{
    ...
    public Booking_BookingWithOutSlot()
    {
        manualCheckInGridUrl = baseUrl + "DeviceMacDeatails?branchId=";
        manualVehicleTypeDdlUrl = baseUrl + "vehicleConfigMaster?activeStatus=A";
        manualCheckingPostUrl = baseUrl + "DeviceMacDeatails1";
    }
    #region Page Load
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (StatusCode == 1)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            if (dt.Rows[0]["vehicleName"].ToString() == "Car")
                            {
                                divSummary.Style.Add("background-image", "../images/Backgroundcar.png");
                                divSummary.Style.Add("background-repeat", "no-repeat");
                                divSummary.Style.Add("opacity", "0.75");
                            }
                            else if (dt.Rows[0]["vehicleTypeName"].ToString() == "Bike")
                            {
                                divSummary.Style.Add("background-image", "../images/Backgroundbike.png");
                                divSummary.Style.Add("background-repeat", "no-repeat");
                                divSummary.Style.Add("opacity", "0.75");
                            }
                            ...
                            HtmlControl divrower = gvVehicleType.Items[i].FindControl("divvehicles") as HtmlControl;
                            divrower.Attributes["class"] = "carimage2";
                            HtmlControl divcarname = gvVehicleType.Items[i].FindControl("divcarname") as HtmlControl;
                            ...
                            bookingbackground.Style.Add("background-image", "../images/Backgroundcar.png");
                            bookingbackground.Style.Add("background-repeat", "no-repeat");
                            bookingbackground.Style.Add("opacity", "0.2");
                            bookingbackground.Style.Add("height", "240px");
                            bookingbackground.Style.Add("background-position", "center");
                            bookingbackground.Style.Add("background-size", "50%");
                            bookingbackground.Style.Add("margin-top", "-5rem");
    ...
    protected void lblVehicleTypes_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lblVehicleTypeId.Text = ViewState["vehicleType"].ToString().Trim();
            ImgSummary.ImageUrl = ViewState["vehiclePlaceHolderImageUrl"].ToString().Trim();
            ImgSummary1.ImageUrl = ViewState["vehiclePlaceHolderImageUrl"].ToString().Trim();
            ...
            {
                bookingbackground.Style.Add("background-image", "../images/Backgroundbike.png");
                bookingbackground.Style.Add("background-size", "40%");
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (StatusCode == 1)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            if (dt.Rows[0]["slotExits"].ToString() == "Y")
                            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (StatusCode == 1)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Response.Redirect("Print.aspx?rt=b&bi=" + ResponseMsg1.ToString() + "", false);
                            }
                        }
            ...
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (StatusCode == 1)
                    {
                        ...
                        if (ddlPaymentType.SelectedItem.Text == "Online" && txtmobileNo.Text != "")
                        {
                            SendPaymentLink(txtmobileNo.Text, BookingId.ToString());
                        }
                        else
                        {
                            if (BorP.Trim() == "B")
    ...
    public void ClearPass()
    {
        ...
        ddlPaymentType.ClearSelection();
        ddlpaymenttypepass.ClearSelection();
