<%@ Page Title="Check In & Check Out" Language="C#" MasterPageFile="~/PreParking.master" AutoEventWireup="true"
    CodeFile="CheckInCheckOut_Old.aspx.cs" Inherits="CheckInandOut_CheckInCheckOut" EnableEventValidation="false" %>
...
<asp:Content ID="cnCheckInCheckOut" ContentPlaceHolderID="MasterPage" runat="Server">
    ...
    <div class="container-fluid containerBg" id="divScreen" runat="server">
        ...
        <div id="divForm" runat="server" visible="true">
            <div class="row" style="margin-top: -16px;" id="divBlockFloor" runat="server">
                <div class="col-12 col-sm-4 col-md-4 col-lg-3 col-xl-3" id="divSlotlistdetails" runat="server">
                    <asp:Label
                        ID="lblblock"
                        runat="server" Font-Bold="true">Block
                    ...
                    <asp:RequiredFieldValidator
                        ID="rfdblock"
                        ValidationGroup="CheckINCheckOut"
