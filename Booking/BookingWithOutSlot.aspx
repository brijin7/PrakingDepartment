<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookingWithOutSlot.aspx.cs" Inherits="Booking_BookingWithOutSlot" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1"
            ...
            <ContentTemplate>
                                    ...
                                    <div class="row">
                                     ...
                                     <asp:Label ID="lblFloorName" runat="server" Font-Bold="true"></asp:Label>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6">
                                            <div class="row" style="padding: 3px; margin-left: 10px;">
                                                <div class="col-sm-5 col-md-5 col-lg-5 col-xs-12">
                                                    <asp:Image ID="ImgExtnVhcl" runat="server" Visible="false" Style="height: 3.5rem; margin-top: -14px;" />
                                                    <label for="lblmaxcharge" class="labels">
                                                        Vehicle No.
                                                    </label>
                                                </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <asp:Label ID="lblReFloorName" runat="server" Font-Bold="true"></asp:Label>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6">
                                            <div class="row" style="padding: 3px; margin-left: 10px;">
                                                <div class="col-sm-5 col-md-5 col-lg-5 col-xs-12">
                                                    <asp:Image ID="ImgRemVhcl" runat="server" Visible="false" Style="height: 3.5rem; margin-top: -14px;" />
                                                    <label for="lblmaxcharge" class="labels">
                                                        Vehicle No.
                                                    </label>
                                                </div>
                                ...
                                <div id="divpass" runat="server" visible="false" style="margin-right: 1rem">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6">
                                            <div class="row" style="padding: 3px; margin-left: 10px;">
                                                <div class="col-sm-5 col-md-5 col-lg-5 col-xs-12">
                                                    <asp:Image ID="ImgPasVhcl" runat="server" Visible="false" Style="height: 3.5rem; margin-top: -14px;" />
                                                    <label for="lblmaxcharge" class="labels">
                                                        Vehicle No.
                                                    </label>
                                                </div>
                                                ...
                                                <asp:LinkButton ID="DivVehile" runat="server" OnClick="lblVehicleTypesPass_Click">
                                                    <div class="row" style="width: max-content;">
                                                        <div id="divcarnames" runat="server" class="col-xs-9 col-sm-9 col-md-9 col-lg-9 divcarname" style="margin-right: -40px;">
                                                            <asp:Image ID="lblVehicleTypes" Style="height: 35px !important; width: 35px;"
                ...
                <i class="fa-solid fa-xmark"></i></asp:LinkButton>
                                            ...
                                            <div class="Date__Container" style="margin-bottom: 1rem" id="divMain" runat="server">
                                                ...
                                                <div class="Date To__Date Grpbooking" style="width: 530px;">
                                                    ...
                                                    <div style="display: flex; margin-bottom: 0rem;">
                                                        ...
                                                        <div class="col-12 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" id="divVehicleNo" runat="server" visible="false">
                                                        ...
                                                        <div class="col-12 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" visible="false" id="divddlVehicle" runat="server">
                                                            <asp:Image ID="ImgSummary1" runat="server" Style="height: 3.5rem; margin-top: -14px;" />
                                                            <asp:Label
                                                            ...
                                                            <asp:DropDownList
                                                                ...
                                                                runat="server"
                                                                TabIndex="10" OnSelectedIndexChanged="ddlVehicle_SelectedIndexChanged"
                                                                CssClass="form-control">
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator
                                                                ID="rfvddlVehicleNo"
                    ...
                    <div id="bookingbackground" runat="server">
                    </div>
                </fieldset>
            </ContentTemplate>
        </asp:UpdatePanel>
